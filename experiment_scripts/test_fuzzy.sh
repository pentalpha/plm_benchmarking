...
python bin/test_embedding.py $N_TESTS $fuzzy_parquet_name True "input_data/emb.ankh_base.parquet:mean"
python bin/test_embedding.py $N_TESTS $u900_parquet_name True "input_data/emb.ankh_base.parquet:mean"
python bin/test_embedding.py $N_TESTS $classic_parquet_name True "input_data/emb.ankh_base.parquet:mean"
