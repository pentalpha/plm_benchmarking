...
python bin/pooling_exploration-train.py $N_TARGETS $MIN_ANNOTATIONS $MAX_TRAIN_PROTEINS \
    $BASE_RESULTS_DIR/parti_std_max_pooling_test "${BASE_FEATURE_NAME}parti.parquet:parti" "${BASE_FEATURE_NAME}max.parquet:max" "${BASE_FEATURE_NAME}std.parquet:std"
python bin/pooling_exploration-train.py $N_TARGETS $MIN_ANNOTATIONS $MAX_TRAIN_PROTEINS \
    $BASE_RESULTS_DIR/mean_std_max_pooling_test "${BASE_FEATURE_NAME}mean.parquet:mean" "${BASE_FEATURE_NAME}max.parquet:max" "${BASE_FEATURE_NAME}std.parquet:std"
python bin/pooling_exploration-train.py $N_TARGETS $MIN_ANNOTATIONS $MAX_TRAIN_PROTEINS \
    $BASE_RESULTS_DIR/softmax_std_max_pooling_test "${BASE_FEATURE_NAME}softmax.parquet:softmax" "${BASE_FEATURE_NAME}max.parquet:max" "${BASE_FEATURE_NAME}std.parquet:std"
python bin/pooling_exploration-train.py $N_TARGETS $MIN_ANNOTATIONS $MAX_TRAIN_PROTEINS \
    $BASE_RESULTS_DIR/norm_std_max_pooling_test "${BASE_FEATURE_NAME}norm.parquet:norm" "${BASE_FEATURE_NAME}max.parquet:max" "${BASE_FEATURE_NAME}std.parquet:std"

python bin/pooling_exploration-summarize.py